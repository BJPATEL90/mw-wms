...
function showProcessing(msg){
  document.getElementById('procMsg').innerText = msg || 'Processing…';
  document.getElementById('procSubMsg').innerText = '';
  document.getElementById('procOverlay').classList.add('visible');
  clearTimeout(_procTimer);
  _procTimer = setTimeout(function(){
    const sub = document.getElementById('procSubMsg');
    if(sub) sub.innerText = 'Taking longer than expected — still processing…';
  }, 10000);
}
