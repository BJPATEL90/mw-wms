...
function saveNewBin(){
  ...
  binMaster.push({id,zone:document.getElementById('nb_zone').value.trim(),fsn:document.getElementById('nb_fsn').value,capacity:Number(document.getElementById('nb_qty').value)||null,status:document.getElementById('nb_status').value,skuFromDump:''});
